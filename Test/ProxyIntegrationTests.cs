...
public class ProxyIntegrationTests
{
    ...
    public ProxyIntegrationTests()
    {
        ...
        // 1. 注册我们的代理组件
        services.AddProxyHttpClient(client => { client.DefaultRequestHeaders.Add("User-Agent", "XUnit-Test"); });
    ...
    {
        var proxy1 = new ProxyConfig("222.123.123.111", 12312, "aaaa", "bbbb");
    ...
    public async Task NamedClient_WithMultipleProxies_ShouldBeIsolated()
    {
        ...
        var proxyA = new ProxyConfig("222.123.123.111", 12312, "aaaa", "bbbb");
        var proxyB = new ProxyConfig("222.123.123.115", 12312, "aaaa", "bbbb");
